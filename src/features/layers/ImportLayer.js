        ...
        <Modal.Body>
          <Accordion className="mb-4">
            <Card className="active mt-2">
              ...
              >
                <h3>Import</h3>
                Imports a pattern file as a new layer. Supported formats are
                .thr, .gcode, and .nc.
                <Form.Control
                  id="fileUpload"
                  type="file"
          ...
          <div className="mt-2">
            ...
            <p>
              ...
              their labor, intensity, and ideas into this art. The creators have
              a right to own it (and they have a copyright, even if it
              doesn&apos;t say so). If you don&apos;t have permisson (a license)
              to use their art, then you shouldn&apos;t be. If you do have
              permission to use their art, then you should be thankful, and
              I&apos;m sure they would appreciate you sending them a note of
              thanks. A picture of your table creating their shared art would
              probably make them smile.
            </p>
            <p>
